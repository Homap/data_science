...
To create the codon table, from within the *annotate* folder simply run:

`python degeneracy_per_codon.py`

To annotate your genome of interest, from within the *annotate* folder run (using the example data):
